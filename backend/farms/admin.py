...
class FarmAdmin(admin.ModelAdmin):
    actions = ["reset_trial_period", "grant_lifetime_access"]

    @admin.action(description="Reset 60-Day Free Trial")
    ...
    @admin.action(description="Grant Lifetime Free Access (Comped)")
