...
class FarmProfile(models.Model):
    ...
    volunteer_perks = models.TextField(
        blank=True, null=True, help_text="e.g., Free produce, college credit, community meals."
    )
    physical_requirements = models.TextField(
        blank=True, null=True, help_text="e.g., Must lift 50lbs, kneeling required, 18+ only."
    )
